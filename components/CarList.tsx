...
import { FaEthereum, FaMapMarkerAlt, FaClock, FaFilter, FaSearch } from 'react-icons/fa'
...
const CarList: React.FC<CarListProps> = ({ cars, loading }) => {
  ...
  const filteredCars = cars.filter((car) => {
    ...
    const matchesTransmission = !filters.transmission || car.transmission.toString() === filters.transmission
              ...
              <div className="bg-gray-900 h-[70vh] w-full absolute bottom-0 rounded-t-2xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    {Object.entries(CarTransmission).map(([key, value]) => (
                      typeof value === 'number' && 
                      <option key={value} value={value}>
                        {key}
                      </option>
          ...
          >
            ...
            <div className="p-4 md:p-6">
              <div className="flex justify-between items-start mb-3 md:mb-4">
                <div>
                  <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">{car.name}</h3>
